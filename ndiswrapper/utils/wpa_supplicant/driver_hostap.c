				  ...
				  int reason_code)
{
	 ...
	 * disassociating than sending with Prism2/2.5/3 than sending the
	 * management frame and then resetting the Port0 to make sure both the
	 * AP and the STA end up in disconnected state. */
