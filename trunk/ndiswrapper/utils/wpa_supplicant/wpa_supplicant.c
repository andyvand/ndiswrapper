...
"wpa_supplicant v0.2.3 - Copyright (c) 2003-2004, Jouni Malinen "
"<jkmaline@cc.hut.fi>";
...
int wpa_eapol_send(void *ctx, int type, u8 *buf, size_t len)
{
	...
	memcpy(ethhdr->h_dest, wpa_s->bssid, ETH_ALEN);
...
extern struct wpa_driver_ops wpa_driver_ndiswrapper_ops; /* driver_wext.c */
#endif /* CONFIG_DRIVER_WEXT */
